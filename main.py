...
def lambda_handler(event, context):
    ...
    return {"statusCode": 200, "body": json.dumps(generate_signed_url(S3_BUCKET, requested_key))}
...
def generate_signed_url(bucket, key):
    ...
    signed_urls = [
        {"key": obj["Key"], "url": s3.generate_presigned_url("get_object", Params={"Bucket": bucket, "Key": obj["Key"]}, ExpiresIn=60 * 5)}
